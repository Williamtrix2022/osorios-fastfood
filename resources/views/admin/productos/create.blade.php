...
@section('title', 'Crear Producto - OsoriosFoodApp')
@section('page-title', 'Crear Producto')
@section('page-subtitle', 'Agrega un nuevo producto al menú')
        ...
        <form action="{{ route('admin.productos.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="imagen" class="block text-white font-semibold mb-2">
                    <i class="fas fa-image mr-2 text-gold"></i>Imagen del Producto
                </label>
